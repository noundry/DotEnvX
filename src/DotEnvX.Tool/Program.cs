...
namespace Noundry.DotEnvX.Tool;
...
class Program
{
    ...
    static Noundry.DotEnvX.Core.Encryption.DotEnvEncryption.KeyPair EnsureKeypair(string file)
    {
        ...
        if (File.Exists(".env.keys"))
        {
            ...
            {
                return new Noundry.DotEnvX.Core.Encryption.DotEnvEncryption.KeyPair
                {
